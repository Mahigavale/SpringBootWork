...
import com.ott.Cornflix.Service.Login_Service;
...
public class Login_Controller {
	...
	public String adduser(@RequestBody Login login)
	{
		...
		return "the user with the name and id :" +login.getUser_id()+" "+login.getUser_name()+"is added sucessfully !";
	}
	...
	public String deleteuserwithname(@RequestParam("id") String id)
	{
		...
		return "the user with user id :+"+id+"is deleted sucessfully !";
	}
	...
	public String updateuserpassword(@RequestBody Login login)
	{
	     ...
	     return ("the user "+login.getUser_name()+" is updated sucessfully !");
	}
